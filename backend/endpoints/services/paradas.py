import json
from ..db import obtener_usuario_por_viaje, insertar_parada_con_iman, obtener_ciudad_por_id, eliminar_parada_por_id, actualizar_relato_parada_db, eliminar_relato_parada_db, actualizar_ciudad_parada_db
