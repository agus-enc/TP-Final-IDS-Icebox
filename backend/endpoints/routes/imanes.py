...
from ..validators.imanes import validar_id_iman, validar_autorizacion_iman
...
def obtener_imanes():
    ...
    try:
        ...
        imanes = listar_imanes(id_usuario_validado, ubicacion_param)
        return jsonify(imanes), 200
    
    except ValueError as e:
        return jsonify(e.args[0]), 400
    except Exception as e:
        return jsonify(construir_error("INTERNAL_ERROR", "Error al obtener imanes", str(e))), 500
